                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center gap-1">
                            ...
                            {{-- <a href="" data-bs-toggle="modal"
                                ...
                                <a href="{{ route('localChurch.certificate.transferCert',encrypt($item->id)) }}" class="btn btn-sm btn-success" target="_blank" title="Download"><i class="ti ti-download"></i></a>
                                    ...
                                    <div class="modal-content modal-filled">
                                        <div class="modal-body p-4">
                                            <div>
                                                ...
                                                <form
                                                    action="{{ route('localChurch.recommandation.transferApprove',$item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-2">
                                    ...
                                    <div class="modal-content modal-filled">
                                        <div class="modal-body p-4">
                                            <div>
                                                ...
                                                <form
                                                    action="{{ route('localChurch.recommandation.transferReject',$item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-2">
