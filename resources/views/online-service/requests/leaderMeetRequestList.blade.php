    ...
    <div class="card">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-9">
                <h4 class="mb-0">Guhura Numuyobozi Requests</h4>
            </div>
                                    ...
                                    <div class="modal-content modal-filled">
                                        <div class="modal-body p-4">
                                            <div>
                                                ...
                                                <form
                                                    action="{{ route('localChurch.request.leaderMeetRequestApprove',$item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-2">
                                    ...
                                    <div class="modal-content modal-filled">
                                        <div class="modal-body p-4">
                                            <div>
                                                ...
                                                <form
                                                    action="{{ route('localChurch.request.leaderMeetRequestReject',$item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-2">
