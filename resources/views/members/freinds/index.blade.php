    ...
    <div class="card">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-9">
                <h4 class="mb-0">Freinds List</h4>

                <div class="btn-group">
                    <a href="{{ route('localChurch.friend.create') }}" class="btn btn-primary">Add Member</a>
                </div>
            ...
            <table id="datatable" class="table align-middle text-nowrap mb-0" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('localChurch.friend.show',$item->id) }}"
                                class="btn btn-sm btn-primary">Profile</a>
                            <a href="{{ route('localChurch.friend.edit',$item->id) }}"
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content modal-filled bg-light-danger">
                                        <div class="modal-body p-4">
                                            <form action="{{ route('localChurch.friend.destroy',$item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <div class="text-center text-danger">
                                                    ...
                                                    <p class="mt-3">
                                                        Delete Friend will permanently remove the member
                                                        from your list.
                                                    </p>
