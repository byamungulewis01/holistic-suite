...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('localChurch.children.store') }}" method="POST">
                @csrf
                ...
                <div class="card-body">
                    ...
                    @if(Request::routeIs('localChurch.memberProfile.addChild'))
                    <input type="hidden" name="member_id" value="{{ $id }}">
                    @elseif(Request::routeIs('localChurch.sundaySchool.addChild'))
                    <input type="hidden" name="sunday_school_id" value="{{ $sunday_school_id }}">
                    @endif
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3">
                            <div>
                                ...
                                <div class="input-group">
                                    <input name="dateOfPrayer" type="text" class="form-control" id="datepicker-autoclose1"  autocomplete="off"
                                     value="{{ old('dateOfPrayer') }}" placeholder="mm/dd/yyyy" />
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="orphanStatus" class="form-select" style="height: 36px; width: 100%" required>
                                ...
                                <option {{ old('orphanStatus') == $item['id'] ? 'selected' : '' }}
                                    value="{{ $item['id'] }}">{{ $item['name'] }}</option>
                                @endforeach
                            </select>
                            @error('orphanStatus')
