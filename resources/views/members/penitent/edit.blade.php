...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('localChurch.penitent.update',$penitent->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-header">
                    <h5 class="card-title mb-0">Penitent Update</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                value="{{ $penitent->name }}" required autocomplete="off" autofocus>
                            @error('name')
                        ...
                        <div class="col-lg-4">
                            <div>
                                ...
                                <input type="text" class="form-control number" name="phone" id="phone" minlength="10"
                                    maxlength="10" value="{{ $penitent->phone }}"
                                    autocomplete="off">
                                @error('phone')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-lg-4">
                            <div>
                                ...
                                <input type="email" class="form-control" name="email" id="email"
                                 value="{{ $penitent->email }}" autocomplete="off">
                                @error('email')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control number" name="nid" id="nid" minlength="16"
                                maxlength="16" value="{{ $penitent->nid }}"
                                autocomplete="off">
                            @error('nid')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-lg-4">
                            ...
                            <select name="province" class="form-select" style="height: 36px; width: 100%" required>
                                ...
                                <option {{ $penitent->province_id == $item->Prov_ID ? 'selected':'' }}
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-select" id="district" name="district" style="width: 100%; height: 36px"
                                required>
                                <option value="{{ $penitent->district_id }}" selected>
                                    {{ $penitent->district }}
                                </option>
                            </select>
                            @error('district')
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-select" id="sector" name="sector" style="width: 100%; height: 36px"
                                required>
                                <option value="{{ $penitent->sector_id }}" selected>
                                    {{ $penitent->sector }}
                                </option>
                            </select>
                            @error('sector')
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-select" id="cell" name="cell" style="width: 100%; height: 36px"
                                required>
                                <option value="{{ $penitent->cell_id }}" selected>
                                    {{ $penitent->cell }}
                                </option>
                            </select>
                            @error('cell')
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-select" id="village" name="village" style="width: 100%; height: 36px"
                                required>
                                <option value="{{ $penitent->village }}" selected>
                                    {{ $penitent->village }}
                                </option>
                            </select>
                            @error('village')
                    ...
                    <div class="row g-3">
                        <div class="col-lg-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input primary check-outline outline-primary" type="radio"
                                    id="male" name="gender" value="1" @if(!$penitent->gender || $penitent->gender == 1) checked
                                    @endif>
                                <label class="form-check-label" for="male">{{ __('message.gender.0.name') }}</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input primary check-outline outline-primary" type="radio"
                                    id="female" name="gender" value="2" @if($penitent->gender==2) checked @endif>
                        ...
                        <div class="col-lg-3">
                            <div>
                                ...
                                <select name="marital_status" id="marital_status" class="form-select" required>
                                    ...
                                    <option {{ $penitent->marital_status_id == $status['id'] ? 'selected' : '' }}
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    <input name="dateOfBirth" type="text" class="form-control" id="datepicker-autoclose"
                                        required value="{{ $penitent->dateOfBirth }}" placeholder="mm/dd/yyyy" />
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="education" id="education" class="form-select" required>
                                ...
                                <option {{ $penitent->education_id == $item['id'] ? 'selected' : '' }}
                                    value="{{ $item['id'] }}">
                                    {{ $item['name'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="disability" id="disability"
                                value="{{ $penitent->disability }}" placeholder="Enter Disability" autocomplete="off">
                            @error('disability')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="training" id="training"
                                value="{{ $penitent->training }}" placeholder="Enter Training" autocomplete="off">
                            @error('training')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="professional" id="professional"
                                value="{{ $penitent->professional }}" placeholder="Enter Professional" autocomplete="off">
                            @error('professional')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="employer" id="employer"
                                value="{{ $penitent->employer }}" placeholder="Enter Employer" autocomplete="off">
                            @error('employer')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-lg-6">
                            ...
                            <select name="field[]" id="field" class="select2 form-select" multiple="multiple"
                                ...
                                <option @foreach (explode(',',$penitent->field_id) as $field) {{ $field == $item['id'] ? 'selected' : '' }} @endforeach
                                    value="{{ $item['id'] }}">
                                    {{ $item['name'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="insurance" class="form-select" style="height: 36px; width: 100%" required>
                                ...
                                <option {{ $penitent->insurance_id == $item['id'] ? 'selected' : '' }}
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="saving" class="form-select" style="height: 36px; width: 100%">
                                ...
                                <option {{ $penitent->saving_id == $item['id'] ? 'selected' : '' }} value="{{ $item['id'] }}">
                                    {{ $item['name'] }}</option>
                                @endforeach
                            </select>
                            @error('saving')
                        ...
                        <div class="col-lg-4">
                            <div class="mb-2">
                                ...
                                <select name="relation" class="form-select" style="height: 36px; width: 100%" required>
                                    ...
                                    <option {{ $penitent->relation == $item['id'] ? 'selected' : '' }}
                                        value="{{ $item['id'] }}">{{ $item['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('relation')
                            ...
                            <div class="mb-2">
                                ...
                                <select name="service" class="form-select" style="height: 36px; width: 100%" required>
                                    ...
                                    <option {{ $penitent->service_type_id == $item['id'] ? 'selected' : '' }}
                                        value="{{ $item['id'] }}">{{ $item['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('service')
                            ...
                            <div class="mb-2">
                                ...
                                <select name="religion" class="form-select" style="height: 36px; width: 100%" required>
                                    ...
                                    <option {{ $penitent->previus_religion_id == $item['id'] ? 'selected' : '' }}
                                        value="{{ $item['id'] }}">{{ $item['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('religion')
                        ...
                        <div class="col-lg-8">
                            ...
                            <textarea name="motif" class="form-control" id="motif" rows="8"
                                placeholder="Enter Motification for Penitent" required>{{ $penitent->motif }}</textarea>
