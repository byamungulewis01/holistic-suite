    ...
    <div class="card">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-9">
                <h4 class="mb-0">Penitent List</h4>

                <div class="btn-group">
                    <a href="{{ route('localChurch.penitent.create') }}" class="btn btn-primary">Add Penitent</a>
                </div>
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content modal-filled bg-light-danger">
                                        <div class="modal-body p-4">
                                            <form action="{{ route('localChurch.penitent.destroy',$item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <div class="text-center text-danger">
                                                    ...
                                                    <p class="mt-3">
                                                        Delete Penitent will permanently remove the member
                                                        from your list.
                                                    </p>
