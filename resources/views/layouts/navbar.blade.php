        ...
        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
          <li class="nav-item dropdown">
            <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="{{ Config::get('languages')[App::getLocale()]['flag'] }}" alt="" class="rounded-circle object-fit-cover round-20">
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
              <div class="message-body" data-simplebar>
                @foreach (Config::get('languages') as $lang => $language)
                 ...
                 <a href="{{ route('lang.switch',$lang) }}" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                   <div class="position-relative">
                     <img src="{{ $language['flag'] }}" alt="" class="rounded-circle object-fit-cover round-20">
                   </div>
            ...
            <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown" aria-expanded="false">
              <div class="d-flex align-items-center">
                <div class="user-profile-img">
                   ...
                   @endphp
                  <img src="{{ asset('dist/images/profile/'.$photo) }}" class="rounded-circle" width="35" height="35" alt="" />
                </div>
              </div>
            </a>
            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
              <div class="profile-dropdown position-relative" data-simplebar>
                ...
                <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                  ...
                  <img src="{{ asset('dist/images/profile/'.$photo) }}" class="rounded-circle" width="80" height="80" alt="" />
                  <div class="ms-3">
