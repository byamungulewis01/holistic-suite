    ...
    <div class="card">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-9">
                <h4 class="mb-0"><strong class="text-primary" >Region {{ \App\Models\Office::findorfail(auth()->user()->region_id)->name }} </strong> Parishes</h4>
                    ...
                    <div class="modal fade" id="addModel" tabindex="-1" aria-labelledby="exampleModalLabel1">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content p-3">
                                ...
                                <form action="{{ route('region.office.storeParish') }}" method="POST">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <form action="{{ route('region.office.destroyParish', $item->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
...
<script>
    $(document).on('click', '.editOffice', function () {
        ...
        var route = "{{ route('region.office.updateParish', ['id' => ':id']) }}";
