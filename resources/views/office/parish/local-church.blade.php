    ...
    <div class="card">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-9">
                <h4 class="mb-0"> <strong class="text-primary" >{{ \App\Models\Office::findorfail(auth()->user()->parish_id)->name }} </strong> Local Churches</h4>
                    ...
                    <div class="modal fade" id="addModel" tabindex="-1" aria-labelledby="exampleModalLabel1">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content p-3">
                                ...
                                <form action="{{ route('parish.office.storeLocalChurch') }}" method="POST">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <form action="{{ route('parish.office.destroyLocalChurch', $item->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                    ...
                    <form id="updateform" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="message-text" class="control-label">Cell:</label>
                                    <select class="form-select" name="cell" id="cell"
                                        style="width: 100%; height: 36px">
                                        <option>Select</option>
                                    </select>
                                </div>
...
<script>
    $(document).on('click', '.editOffice', function () {
        ...
        var route = "{{ route('parish.office.updateLocalChurch', ['id' => ':id']) }}";
