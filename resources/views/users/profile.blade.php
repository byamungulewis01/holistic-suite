  ...
  <div class="row">
    <div class="col-lg-6 d-flex align-items-stretch">
      <div class="card w-100 position-relative overflow-hidden">
        ...
        <form id="profile-form" action="{{ route('changeProfilePicture') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-4">
                  ...
                  <input required type="text" class="form-control" id="exampleInputtext" name="name" value="{{ auth()->user()->name }}">
                </div>
                <div class="mb-4">
                  <label for="exampleInputPassword1" class="form-label fw-semibold">Email</label>
                  <input required type="email" class="form-control" id="exampleInputtext" name="email" value="{{ auth()->user()->email }}">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-4">
                  <label for="phone" class="form-label fw-semibold">Phone</label>
                  <input required type="text" minlength="10" maxlength="10" class="form-control" id="phone" name="phone" value="{{ auth()->user()->phone }}">
                </div>
                <div class="mb-4">
                    <label for="exampleInputPassword1" class="form-label fw-semibold">User Name</label>
                    <input required type="text" class="form-control" id="exampleInputtext" name="username" value="{{ auth()->user()->username }}">
                  </div>
              </div>
              <div class="col-12">
