    ...
    <div class="card">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-9">
                <h4 class="mb-0"> <strong class="text-primary" >{{ \App\Models\Office::findorfail(auth()->user()->region_id)->name }}</strong>
                    Region Users</h4>
                <div class="d-flex align-items-center">
                    ...
                    <div class="modal fade" id="addModel" tabindex="-1" aria-labelledby="exampleModalLabel1">
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="{{ route('region.regionUser.store') }}" method="POST">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('region.regionUser.destroy', $item->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
...
<script>
    $(document).on('click', '.editOffice', function () {
            ...
            var route = "{{ route('region.regionUser.update', ['id' => ':id']) }}";
