    ...
    <div class="card">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-9">
                <h4 class="mb-0"> <strong class="text-primary" >{{ \App\Models\Office::findorfail(auth()->user()->parish_id)->name }}</strong>
                    Parish Users</h4>
                <div class="d-flex align-items-center">
                    ...
                    <div class="modal fade" id="addModel" tabindex="-1" aria-labelledby="exampleModalLabel1">
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="{{ route('parish.parishUser.store') }}" method="POST">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('parish.parishUser.destroy', $item->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
...
<script>
    $(document).on('click', '.editOffice', function () {
            ...
            var route = "{{ route('parish.parishUser.update', ['id' => ':id']) }}";
