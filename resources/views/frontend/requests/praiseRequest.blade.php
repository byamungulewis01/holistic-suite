...
<div id="note-full-container" class="note-has-grid row mb-3">
    <div class="col-md-6 single-note-item all-category">
        <div class="card card-body">
            ...
            <h5 class="note-title text-truncate w-75 mb-3" data-noteheading="Icyifuzo cyo gusengera">Gutanga Igitekerezo,Ikifuzo cyangwa Ikibazo
            </h5>
            <div class="note-content">
                <p class="note-inner-content" data-notecontent="Gusaba Umwanya wo Gushima">Gusaba Umwanya wo Gushima</p>
    ...
    <div class="col-lg-6">
        <div class="card">
            <form action="{{ route('member.request.storePraiseRequest') }}" method="POST">
                @csrf
                <div class="card-header">
                    <h5 class="card-title mb-0">Gusaba Umwanya wo Gushima</h5>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
