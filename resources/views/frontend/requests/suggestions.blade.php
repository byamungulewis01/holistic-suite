...
<div id="note-full-container" class="note-has-grid row mb-3">
    ...
    <div class="col-lg-6">
        <div class="card">
            <form action="{{ route('member.request.storeSuggestion') }}" method="POST">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                            <label for="datepicker-autoclose" class="form-label">Inyunganizi <span
                                    class="text-danger">*</span></label>
                            <select name="type" class="form-select" style="height: 36px; width: 100%" required>
                                <option value="" selected disabled>Select</option>
                                @foreach (__('client/words.suggestions') as $item)
