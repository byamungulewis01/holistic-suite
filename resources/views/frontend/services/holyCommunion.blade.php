...
<div id="note-full-container" class="note-has-grid row mb-3">
    <div class="col-md-6 single-note-item all-category">
        <div class="card card-body">
            ...
            <h5 class="note-title text-truncate w-75 mb-3" data-noteheading="Igaburo ryera
            mu rugo">Igaburo ryera
                mu rugo
            </h5>
    ...
    <div class="col-lg-6">
        <div class="card">
            <form action="{{ route('member.memberStep.storeHolyCommunion') }}" method="POST">
                @csrf
                ...
                <div class="card-body">
                            ...
                            <div class="hstack p-2 border rounded mb-3 mb-md-0">
                                <div class="ms-0">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input primary" checked type="radio"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" disabled class="form-control number" minlength="9" maxlength="9" name="reg_number"
                            id="reg_number" placeholder="Enter Reg Number" value="{{ auth()->guard('member')->user()->reg_no }}" required
