...
<body>
    ...
    <h2 style="margin-top: 1%;margin-bottom: 1%;letter-spacing: 3px;">
        ICYEMEZO CY'UBUHAMYA BW'UMUKRISTO
    </h2>
    <div style="width: 100%; background-color:rgb(219, 219, 219);height:2px;"></div>
    ...
    <div style="width: 100%; background-color:rgb(219, 219, 219);height:2px;"></div>
    <p style="line-height: 1.5;">Twabwe <strong>{{ (!$parish_paster) ? '..........................................' : $parish_paster->name }}</strong>
    Umushumba wa ADEPR Paruwase ya {{
        $paruwase->name }},
        ...
        ari umunyetorero ushimwa mu mico no mu myifatire ya gikristo akaba abarizwa muri
         ADEPR Itorero rya <b>{{ $member->localChurch->name }}</b> Paruwase ya <b>{{ $member->parish->name
    ...
    <p>Itariki Icyangobwa Kizamara : {{ \Carbon\Carbon::parse($record->aproovedDate)->addDays(4)->format('d/m/Y')
        }}</b>
    </p>
